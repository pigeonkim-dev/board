...
public class ProfileController {
    ...
    public String me(@AuthenticationPrincipal CustomUserDetails customUserDetails,
        ...
        ProfileResponse profile = profileService.getProfileByEmail(customUserDetails.getUsername());
    ...
    public String edit(@AuthenticationPrincipal CustomUserDetails customUserDetails,
        ...
        profileUpdateRequest.setNickname(profile.getNickname());
    ...
    public String edit(@AuthenticationPrincipal CustomUserDetails customUserDetails,
        ...
        try {
            profileService.updateProfile(profileUpdateRequest, customUserDetails.getUsername());
